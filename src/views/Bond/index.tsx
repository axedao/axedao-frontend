            ...
            <Paper className="ohm-card ohm-modal bond-modal">
              ...
              <Box direction="row" className="bond-price-data-row">
                <div className="bond-price-data">
                  ...
                  <p className="bond-price-data-value mark-gradient-text">
                    {isBondLoading ? (
                      <Skeleton />
                    ) : bond.indexOf('lp') >= 0 ? (
                      `$${trim(bondPrice, 2)}`
                ...
                <div className="bond-price-data">
                  <p className="bond-price-data-title">AXE Price</p>
                  <p className="bond-price-data-value mark-gradient-text"> {isBondLoading ? <Skeleton /> : `$${trim(marketPrice, 2)}`} </p>
                </div>
              </Box>
